...
mqtt_connection = mqtt_connection_builder.mtls_from_path(
    ...
    port= INPUT_PORT,
    cert_filepath="Yolo_test/aws_cert/controlSystem.cert.pem",
    pri_key_filepath="Yolo_test/aws_cert/controlSystem.private.key",
    ca_filepath="Yolo_test/aws_cert/root-CA.crt",
...
def run():
    ...
    aws_subcribe(TOPIC)
    count = 0
    cap = cv2.VideoCapture("rtsp://admin:dat123456@192.168.1.3:554/onvif1", cv2.CAP_FFMPEG)
